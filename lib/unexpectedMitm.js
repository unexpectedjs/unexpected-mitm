                ...
                return expect.promise(function (resolve, reject) {
                    ...
                    mitm.on('connect', function (socket, opts) {
                        ...
                        consumeReadableStream(req, passError(handleError, function (result) {
                            ...
                            function assertMockResponse(mockResponse, mockResponseError, callback) {
                                ...
                                expect.promise(function () {
                                    ...
                                    expect.errorMode = 'nested';
                                    callback(null, mockResponse, mockResponseError);
                                });
                            }
                            ...
                            function deliverMockResponse(mockResponse, mockResponseError) {
                                setImmediate(function () {
                                    ...
                                    if (mockResponseError) {
                                        setImmediate(function () {
                                            if (nonEmptyMockResponse) {
                                                // It appears not to be possible to trigger the actual mockResponseError
                                                // when we have written the headers (and optionally part of the body),
                                                // but calling res.destroy() will make the appear as an ECONNRESET error with
                                                // a message of "socket hang up", which is much better than nothing:
                                                res.destroy();
                                                setImmediate(function () {
                                                    lastHijackedSocket.on('error', function () {});
                            ...
                            function assertAndDeliverMockResponse(mockResponse, mockResponseError) {
                                if (mockResponse && mockResponseError) {
                                    mockResponse.error = mockResponseError;
                                }
                                assertMockResponse(mockResponse, mockResponseError, passError(handleError, deliverMockResponse));
                            }
