    ...
    installInto: function (expect) {
        ...
        expect
            ...
            .addAssertion('<any> with http mocked out <array|object> <assertion>', function (expect, subject, requestDescriptions) { // ...
                ...
                function collectPromise(promise) {
                    if (promise && typeof promise.then === 'function' && typeof promise._fulfill === 'function') {
                ...
                return expect.promise(function (resolve, reject) {
                    ...
                    collectPromise(expect.promise(function () {
                        return collectPromise(expect.shift());
                    })).caught(reject).then(function () {
                        /*
                    ...
                    mitm.disable();
                    return expect.promise.settle(collectedPromises);
                });
            });
    }
};
