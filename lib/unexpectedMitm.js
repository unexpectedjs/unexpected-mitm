...
module.exports = {
    ...
    installInto: function (expect) {
        ...
        expect
            ...
            .addAssertion('<any> with mock exchange written to <string> <assertion>', function (expect, subject, filePathWithoutExt) {
                var testFile = filePathWithoutExt + '.js';

                return executeMitm(expect, subject).then(function (recordedExchanges) {
                    var output = 'module.exports = ' +  stringify(recordedExchanges) + ';\n';
            ...
            .addAssertion('<any> with mock exchange read from <string> <assertion>', function (expect, subject, filePathWithoutExt) {
                ...
                return expect.promise(function () {
                    ...
                    expect.args = [subject, 'with http mocked out', requestDescriptions].concat(expect.args.slice(1));
