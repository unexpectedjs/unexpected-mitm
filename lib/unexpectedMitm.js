...
module.exports = {
    ...
    installInto: function (expect) {
        ...
        expect
            .addAssertion('<any> with http recorded [and injected] <any+>', function (expect, subject) {
                var that = this,
                    stack = callsite(),
                    mitm = createMitm(),
            ...
            .addAssertion('<any> with http mocked out <any+>', function (expect, subject, requestDescriptions) { // ...
                var that = this;
