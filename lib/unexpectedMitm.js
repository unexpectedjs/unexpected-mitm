...
function getMockResponse(responseProperties, cb) {
    ...
    if ((typeof Buffer !== 'undefined' && Buffer.isBuffer(responseProperties.body)) || typeof responseProperties.body === 'string') {
                ...
                return expect.promise(function (resolve, reject) {
                    ...
                    mitm.on('connect', function (socket, opts) {
                        ...
                        bufferStream(req, passError(handleError, function (body) {
                            ...
                            function withResponseProperties(responseProperties) {
                            ...
                            if (noMoreMockedOutRequests) {
                                ...
                                if (typeof responseProperties === 'function') {
                                    responseProperties(requestProperties, passError(handleError, withResponseProperties));
                                } else {
                                    withResponseProperties(responseProperties);
                                }
                            }
                        }));
                    }));
