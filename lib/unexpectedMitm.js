        ...
        expect
            .addAssertion('with http mocked out', function (expect, subject, requestDescriptions) { // ...
                ...
                mitm.on('request', function (req, res) {
                    ...
                    if (expectedRequestProperties && typeof expectedRequestProperties.url === 'string') {
                ...
                this.args.push(function (err) {
                    cleanUp();
                    var numberOfRemainingExchanges = nextRequestDescriptionIndex < requestDescriptions.length - 1;
