...
var messy = require('messy'),
    ...
    serializeAsync = require('serializeasync');
...
console.log('REPLAY', req.method, req.url);
console.log("SAT", httpConversationSnapshot.exchanges.length, httpConversationSatisfySpecSnapshot.exchanges.length);
