                ...
                mitm.on('request', function (req, res) {
                    ...
                    req.on('data', function (chunk) {
                        ...
                        function assertAndDeliverMockResponse() {
                            ...
                            if (Array.isArray(mockResponseBody) || (mockResponseBody && typeof mockResponseBody === 'object' && (typeof Buffer === 'undefined' || !Buffer.isBuffer(mockResponseBody)))) {
                                if (!mockResponse.headers.has('Content-Type')) {
                                    mockResponse.headers.set('Content-Type', 'application/json');
                                }
                                mockResponseBody = JSON.stringify(mockResponseBody);
                            }
